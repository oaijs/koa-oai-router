...
import SwaggerExplorerV3 from './oai-explorer-v3';
...
class OAIRouter extends Router {
  ...
  hookEndpoint(method, endpoint, operationData) {
    ...
    _.each(operationData, (fieldData, field) => {
  ...
  /**
   * OpenApi doc explorer v3 middleware.
   * @returns {function} koa middleware
   */
  apiExplorerV3() {
    return new SwaggerExplorerV3(this.apiExplorerConfig());
  }
}
